 ...
 * Board identifier.
 */
#define BOARD_R2D_GW_MODULE
#define BOARD_NAME                  "R2D CAN-Ethernet gateway module"
...
/*
 * Board PHY confgiuration.
 */
#define BOARD_PHY_ID                MII_DP83848I_ID
#define BOARD_PHY_RMII              TRUE

/*
 * IO pins assignments.
 */
#define GPIOA_RMII_CRS              0
#define GPIOA_RMII_REF_CLK          1
#define GPIOA_RMII_MDIO             2
#define GPIOA_PIN3                  3
#define GPIOA_PIN4                  4
#define GPIOA_PIN5                  5
#define GPIOA_PIN6                  6
#define GPIOA_RMII_CRS_DV           7
#define GPIOA_PIN8                  8
#define GPIOA_VBUS_FS               9
#define GPIOA_OTG_FS_ID             10
#define GPIOA_OTG_FS_DM             11
#define GPIOA_OTG_FS_DP             12
#define GPIOA_JTMS_SWDIO            13
#define GPIOA_JTCK_SWCLK            14
#define GPIOA_JTDI                  15

#define GPIOB_PIN0                  0
#define GPIOB_PIN1                  1
#define GPIOB_PIN2                  2
#define GPIOB_JTDO_SWO              3
...
#define GPIOB_RMII_TX_EN            11
#define GPIOB_RMII_TXD0             12
#define GPIOB_RMII_TXD1             13
#define GPIOB_PIN14                 14
#define GPIOB_PIN15                 15

#define GPIOC_OTG_FS_POWER_ON       0
#define GPIOC_RMII_MDC              1
#define GPIOC_PIN2                  2
#define GPIOC_PIN3                  3
#define GPIOC_RMII_RXD0             4
#define GPIOC_RMII_RXD1             5
#define GPIOC_PIN6                  6
#define GPIOC_PIN7                  7
#define GPIOC_PIN8                  8
#define GPIOC_PIN9                  9
 ...
 * PA13 - JTMS_SWDIO                (alternate 0).
 * PA14 - JTCK_SWCLK                (alternate 0).
 * PA15 - JTDI                      (alternate 0).
 */
#define VAL_GPIOA_MODER             (PIN_MODE_ALTERNATE(GPIOA_RMII_CRS) |           \
                                     ...
                                     PIN_MODE_ALTERNATE(GPIOA_JTMS_SWDIO) |         \
                                     PIN_MODE_ALTERNATE(GPIOA_JTCK_SWCLK) |         \
                                     PIN_MODE_ALTERNATE(GPIOA_JTDI))

#define VAL_GPIOA_OTYPER            (PIN_OTYPE_PUSHPULL(GPIOA_RMII_CRS) |           \
...
#define VAL_GPIOA_OSPEEDR           (PIN_OSPEED_100M(GPIOA_RMII_CRS) |              \
                                     PIN_OSPEED_100M(GPIOA_RMII_REF_CLK) |          \
                                     PIN_OSPEED_100M(GPIOA_RMII_MDIO) |             \
                                     PIN_OSPEED_100M(GPIOA_PIN3) |                  \
                                     PIN_OSPEED_100M(GPIOA_PIN4) |                  \
                                     PIN_OSPEED_100M(GPIOA_PIN5) |                  \
                                     PIN_OSPEED_100M(GPIOA_PIN6) |                  \
                                     PIN_OSPEED_100M(GPIOA_RMII_CRS_DV) |           \
                                     ...
                                     PIN_OSPEED_100M(GPIOA_JTMS_SWDIO) |            \
                                     PIN_OSPEED_100M(GPIOA_JTCK_SWCLK) |            \
                                     PIN_OSPEED_100M(GPIOA_JTDI))

#define VAL_GPIOA_PUPDR             (PIN_PUPDR_FLOATING(GPIOA_RMII_CRS) |           \
...
#define VAL_GPIOA_ODR               (PIN_ODR_HIGH(GPIOA_RMII_CRS) |                 \
                                     ...
                                     PIN_ODR_HIGH(GPIOA_JTMS_SWDIO) |               \
                                     PIN_ODR_HIGH(GPIOA_JTCK_SWCLK) |               \
                                     PIN_ODR_HIGH(GPIOA_JTDI))

#define VAL_GPIOA_AFRL              (PIN_AFIO_AF(GPIOA_RMII_CRS, 11) |              \
...
#define VAL_GPIOA_AFRH              (PIN_AFIO_AF(GPIOA_PIN8, 0) |                   \
                                     ...
                                     PIN_AFIO_AF(GPIOA_JTMS_SWDIO, 0) |             \
                                     PIN_AFIO_AF(GPIOA_JTCK_SWCLK, 0) |             \
...
#define VAL_GPIOB_MODER             (PIN_MODE_INPUT(GPIOB_PIN0) |                   \
                                     ...
                                     PIN_MODE_ALTERNATE(GPIOB_JTDO_SWO) |           \
...
#define VAL_GPIOB_OTYPER            (PIN_OTYPE_PUSHPULL(GPIOB_PIN0) |               \
                                     ...
                                     PIN_OTYPE_PUSHPULL(GPIOB_JTDO_SWO) |           \
...
#define VAL_GPIOB_OSPEEDR           (PIN_OSPEED_100M(GPIOB_PIN0) |                  \
                                     ...
                                     PIN_OSPEED_100M(GPIOB_JTDO_SWO) |              \
                                     ...
                                     PIN_OSPEED_100M(GPIOB_RMII_TXD0) |             \
                                     PIN_OSPEED_100M(GPIOB_RMII_TXD1) |             \
...
#define VAL_GPIOB_PUPDR             (PIN_PUPDR_PULLUP(GPIOB_PIN0) |                 \
                                     ...
                                     PIN_PUPDR_FLOATING(GPIOB_JTDO_SWO) |           \
...
#define VAL_GPIOB_AFRH              (PIN_AFIO_AF(GPIOB_PIN8, 0) |                   \
                                     ...
                                     PIN_AFIO_AF(GPIOB_RMII_TXD0, 11) |             \
                                     PIN_AFIO_AF(GPIOB_RMII_TXD1, 11) |             \
...
#define VAL_GPIOC_OSPEEDR           (PIN_OSPEED_100M(GPIOC_OTG_FS_POWER_ON) |       \
                                     PIN_OSPEED_100M(GPIOC_RMII_MDC) |              \
                                     PIN_OSPEED_100M(GPIOC_PIN2) |                  \
                                     PIN_OSPEED_100M(GPIOC_PIN3) |                  \
                                     PIN_OSPEED_100M(GPIOC_RMII_RXD0) |             \
                                     PIN_OSPEED_100M(GPIOC_RMII_RXD1) |             \
 ...
 * GPIOD setup:
 *
 * PD0  - CAN1_RX                   (alternate 9 25M).
 * PD1  - CAN1_TX                   (alternate 9 25M).
...
#define VAL_GPIOD_OTYPER            (PIN_OTYPE_OPENDRAIN(GPIOD_CAN1_RX) |           \
                                     PIN_OTYPE_OPENDRAIN(GPIOD_CAN1_TX) |           \
...
#define VAL_GPIOD_OSPEEDR           (PIN_OSPEED_25M(GPIOD_CAN1_RX) |                \
                                     PIN_OSPEED_25M(GPIOD_CAN1_TX) |                \
